...
function buildPage({ title, heading, headingColor, iconColor, svgPath, bodyText, instructionText, extraScript = '' }: PageParams): string {
  return `
    <html>
      <head>
        <title>${title}</title>
...
export function getFailurePage(): string {
  return buildPage({
