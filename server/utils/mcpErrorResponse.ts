 ...
 */
export function createToolError(message: string, details: Record<string, any> = {}) {
  return {
    content: [
      {
        type: 'text',
 ...
 */
export function createProtocolError(code: number, message: string, data: any = null) {
 ...
 * @returns {Object} MCP-compliant tool error response
 */
export function convertErrorToToolError(error: any, context = '') {
 ...
 * @returns {Object} MCP-compliant tool error response
 */
export function createValidationError(paramName: string, reason: string) {
 ...
 * @returns {Object} MCP-compliant tool error response
 */
export function createAuthError(message: string, retryable = false) {
